...
#define DEFAULT_LOOKUP_FILE "/home/zync/WORKSPACE/ndpi_speed/mark7/offline_costs/lookup_table.json"
#define DEFAULT_COST_PROFILE_FILE "/home/zync/WORKSPACE/ndpi_speed/mark7/offline_costs/cost_profile.csv"
...
static void usage(void) {
  printf("ndpiBenchmarkMark7 - offline nDPI benchmark with simulated RSS and cost-aware dispatch\n\n");
  printf("Usage: ndpiBenchmarkMark7 -i <pcap> [options]\n\n");
  printf("Required:\n");
  ...
  printf("Example:\n");
  printf("  ndpiBenchmarkMark7 -i input/Monday-WorkingHours.pcap\n\n");
}
